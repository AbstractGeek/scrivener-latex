...
def parseArguments(args):
    ...
    if not args.compressed_figures:
        args.compressed_figures = os.path.join(args.figure_source,
                                               "compressed")
...
def main():
    ...
    if not args.only_figures:
        ...
        subprocess.run([
            ...
            "latex",
            "-o",
            "scrivener_mmd_compile_temp.tex",
            args.mmd[0],
            "--variable",
        ...
        input_line = find_in_texfile(main_tex_content,
                                     "\\input{scrivener-input.tex}")
